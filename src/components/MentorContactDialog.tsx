...
export function MentorContactDialog() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const subject = encodeURIComponent("Mentor Application");
      ...
      window.location.href = `mailto:mentors@example.com?subject=${subject}&body=${body}`;
      
      toast({
        title: "Application Ready!",
        description: "Your email client will open with your mentor application.",
      });
      
      setOpen(false);
      setFormData({ name: "", email: "", expertise: "", experience: "" });
    } catch (error) {
