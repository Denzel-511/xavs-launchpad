...
import collaborationImg from "../assets/collaborating.png";
import presentationImg from "../assets/student_presenting.png";
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50">
      ...
      <section className="py-24 px-4 bg-background relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          ...
          <img src={presentationImg} alt="Background" className="w-full h-full object-cover grayscale" />
        </div>
      ...
      <section className="relative py-24 px-4 bg-background overflow-hidden">
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-12 font-display">
              Why Attend?
            </h2>
            <div className="grid sm:grid-cols-2 gap-6 text-left">
              {[
                ...
                <div key={idx} className="flex gap-4 p-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl hover:bg-white/20 transition-colors">
                ...
                <Card className="border-border shadow-xl hover-lift">
                  <CardContent className="p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <Button type="submit" size="lg" className="w-full text-lg h-12 font-bold bg-gradient-hero hover:opacity-90 transition-opacity shadow-lg">
                        Submit Request
                      </Button>
                    </form>
                  </CardContent>
