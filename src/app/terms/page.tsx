          ...
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  We collect and store participant information securely. See our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link> for details.
                </p>
              </section>
